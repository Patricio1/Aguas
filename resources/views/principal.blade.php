...
<html class="loading" lang="en" data-textdirection="ltr">
  <head>
    ...
    <link rel="stylesheet" href="datatable/css/styleButtonExport.css"> 
  ...
  <body  id="principal" class="vertical-layout vertical-menu 2-columns   menu-expanded fixed-navbar" data-open="click" data-menu="vertical-menu" data-color="bg-gradient-x-purple-blue" data-col="2-columns">

    <!-- fixed-top-->
    <nav id="navegacion" class="header-navbar navbar-expand-md navbar navbar-with-menu navbar-without-dd-arrow fixed-top navbar-semi-light">
      ...
      <div class="col-12">
          <div class="card">
              <div class="card-header">
                  <h4 class="card-title" id="cmp">Componentes</h4>
...
<!-- // Line Awesome section end -->
    ...
    <script src="datatable/js/buttons.bootstrap.min.js"></script>
